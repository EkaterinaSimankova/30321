...
namespace Simankova.UI.Interfaces
{
    public interface IProductService
    {
        ...
        /// <returns></returns>
        ///public Task<ResponseData<List<Product>>> GetProductListAsync(string? categoryNormalizedName, int pageNo = 1);
        public Task<ResponseData<ProductListModel<Product>>> GetProductListAsync(string? categoryNormalizedName, int pageNo = 1);

        Task<ResponseData<Product>> CreateProductAsync(Product product, IFormFile?
            formFile);
        /// <summary>
        /// Поиск объекта по Id
        /// </summary>
